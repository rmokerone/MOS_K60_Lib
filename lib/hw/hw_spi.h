...
//SPI主机读写函数
uint8 LPLD_SPI_Master_WriteRead(SPI_MemMapPtr ,uint8 ,uint8 ,uint8);
//SPI主机读函数
uint8 LPLD_SPI_Master_Read(SPI_MemMapPtr);
//SPI主机写函数
void LPLD_SPI_Master_Write(SPI_MemMapPtr ,uint8 ,uint8 ,uint8);
